...
const Home: NextPage = () => {
  return (
    <div className="mx-auto from-surface-decorative-cold to-surface-success-subdued bg-gradient-to-br grid place-items-center h-screen gap-4 bg-surface-neutral-subdued">
